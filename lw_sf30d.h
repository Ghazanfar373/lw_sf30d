//----------------------------------------
// www.Lightware.co.za          April 2020
...
class LW_SF30{
	public:
		LW_SF30(HardwareSerial &serial1);
		LW_SF30(HardwareSerial &serial1, HardwareSerial &print);//, TwoWire &wire);
		LW_SF30(uint8_t Wire_i2c, HardwareSerial &print);
